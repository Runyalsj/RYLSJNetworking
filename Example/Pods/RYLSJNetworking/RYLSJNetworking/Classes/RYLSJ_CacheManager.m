...
NSString *const PathSpace =@"RYLSJ_Kit";
...
@interface RYLSJ_CacheManager ()
@property (nonatomic ,copy)NSString *diskCachePath;
@property (nonatomic ,strong) dispatch_queue_t operationQueue;

@end

@implementation RYLSJ_CacheManager
+ (RYLSJ_CacheManager *)sharedInstance{
    static RYLSJ_CacheManager *cacheInstance=nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        cacheInstance = [[RYLSJ_CacheManager alloc] init];
    });
...
- (id)init{
    ...
    if (self) {
        ...
        _operationQueue = dispatch_queue_create("com.dispatch.RYLSJ_CacheManager", DISPATCH_QUEUE_SERIAL);
...
- (void)initCachesfileWithName:(NSString *)name{
    ...
    self.diskCachePath =[[self RYLSJ_KitPath] stringByAppendingPathComponent:name];
