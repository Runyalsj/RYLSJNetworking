...
@class RYLSJ_UploadData;

NS_ASSUME_NONNULL_BEGIN

@interface RYLSJ_URLRequest : NSObject
 ...
 *  为上传请求提供数据
 */
@property (nonatomic, strong, nullable) NSMutableArray<RYLSJ_UploadData *> *uploadDatas;
...
@interface RYLSJ_BatchRequest : NSObject
...
/**
 上传文件数据的类
 */
@interface RYLSJ_UploadData : NSObject
